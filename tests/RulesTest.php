...
class RulesTest extends AbstractTestCase
{
    ...
    public function testFindIncludedByPackageNameWithUnset(): void
    {
    ...
    public function testWithOverrideFile(): void
    {
        $rules = new class extends Rules {
            ...
            {
                return parent::getVendorRules(); // TODO: Change the autogenerated stub
            }

            public function getOverrideRules(): array
            {
                return parent::getOverrideRules(); // TODO: Change the autogenerated stub
            }
        };
